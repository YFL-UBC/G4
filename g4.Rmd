...
hill_slope$dose0 <- hill_slope$dose_nM
hill_slope$dose0[hill_slope$dose0 == 0] <- 0.5


```


plot slope by concentration


```{r}
hill_slope %>% ggplot(aes(x = dose0, y = `b:(Intercept)`)) +
  geom_point() +
  scale_x_log10() +
...
# from DLD1_NuclightRED_20220504_curvefit_slope.R
